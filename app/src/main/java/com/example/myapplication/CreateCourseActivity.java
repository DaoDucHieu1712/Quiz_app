...
public class CreateCourseActivity extends AppCompatActivity {
    ...
    Button saveButton;
    EditText uploadTopic, uploadDesc, uploadTitle;
    String imageURL;
    Uri uri;
    @Override
                ...
                .setValue(course).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(CreateCourseActivity.this, "Saved", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(CreateCourseActivity.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
}